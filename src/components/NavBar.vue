<template>
    <div class="header">
        ...
        <nav class="navbar">
            ...
            <router-link @click="scrollToTop()" to="/menu">Services</router-link>
            <router-link @click="scrollToTop()" to="/table">Session</router-link>
        </nav>
...
.icons .fa-user, .icons .fa-shopping-cart, .icons .fa-bars {
    flex-grow: 1;
    text-align: center;
}
